                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                            ...
                            >
                                ...
                                <p className="flex justify-center mt-2">{renderStars(googleData.rating, "text-white fill-white")}</p>
                                    ...
                                    >
                                        <div className="flex items-center mb-4">
                                            ...
                                            <div>
                                                ...
                                                {new Date(review.publishTime).toLocaleDateString("en-GB", {
                                                    day: "numeric",
                                                    month: "short",
                                                    year: "numeric",
                                                })}
                                        ...
                                        <p className="text-foreground italic mt-2">{review.text?.text}</p>
