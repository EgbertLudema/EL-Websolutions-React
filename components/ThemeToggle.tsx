...
export default function ThemeToggle() {
    ...
    return (
        <button
            className="toggle-container bg-gray-200 dark:bg-slate-500"
            style={{
                ...container,
        ...
        >
            <motion.div
                className="toggle-handle bg-gray-100 dark:bg-slate-300"
                style={{
                    ...handle
                }}
                layout
            ...
            >
                {isDarkMode ? (
                    <svg className="size-4/6 fill-gray-700" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 23.99 24.01">
