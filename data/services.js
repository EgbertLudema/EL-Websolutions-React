...
const services = [
    ...
    },
    {
        ...
        description: "Ik maak op maat gemaakte Wordpress websites zonder template(100% custom)",
        text: "WordPress is een krachtig en flexibel contentmanagementsysteem(CMS) waarmee bedrijven hun online aanwezigheid efficiënt kunnen beheren. Ik bouw op maat gemaakte WordPress-websites, dit doe ik d.m.v. de Oxygen builder. Op deze manier kan ik de website volledig naar wens op maat maken. Daarnaast gebruikt de Oxygenbuilder alleen de benodigde code, in tegenstelling tot standaard Wordpress thema's, waardoor de website snel en licht is.",
        price: "Vanaf €849",
    ...
    },
    {
        ...
        description: "Custom webshops d.m.v. Woocommerce of Shopify, geoptimaliseerd voor conversie",
