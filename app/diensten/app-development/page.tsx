...
export default function AppDevelopmentPage() {
    ...
    const appDevelopment = services.find(s => s.title === "App Development");

    if (!appDevelopment) return null;


    return (
        <>
            <div className="bg-gradient-to-b from-primary/10 to-white dark:from-primary/10 dark:to-slate-900/10">
                <ServiceHero service={appDevelopment} />
                <ServiceDetails service={appDevelopment} />
            </div>
            <GoogleReviews />
            <USPS />
