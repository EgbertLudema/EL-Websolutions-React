    ...
    const faqData = [
        {
            ...
            answer: "Dit verschilt per opdracht. Bij websites begin ik meestal met een intake en een voorstel. Bij freelance samenwerkingen sluit ik aan op de bestaande planning, tools en werkwijze van het team."
        },
        {
            question: "Hoe lang duurt het om een project af te ronden?",
            answer: "Dat hangt af van de scope. Een kleinere website kan binnen enkele weken klaar zijn, terwijl grotere trajecten of freelance inzet over een langere periode kunnen lopen."
        },
        {
            question: "Bied je ook onderhoud en ondersteuning aan?",
            answer: "Ja. Ik help ook met onderhoud, support en doorontwikkeling voor bestaande websites en webshops."
        },
        {
            question: "Hoe ga je om met revisies en feedback?",
            answer: "Feedback is een belangrijk onderdeel van elk traject. Ik werk het liefst met korte lijnen, duidelijke afstemming en tussentijdse terugkoppeling."
        },
        {
            question: "In welke technologieen ben je gespecialiseerd?",
            answer: "Ik werk vooral met React, Next.js, Tailwind CSS, Shopify en WordPress. Daarmee kan ik zowel websites bouwen als teams ondersteunen bij bestaande projecten."
        },
        {
